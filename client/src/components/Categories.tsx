  ...
  return (
    <section id="categories" className="py-20 md:py-28 bg-lavanda/20 relative overflow-hidden" style={{backgroundColor: '#fff6ea'}}>
      <div className="container">
        ...
        {/* Cards Grid - Fixed Structure */}
        <div className="max-w-7xl mx-auto">
          {/* Desktop Grid: 3 columns fixed layout */}
          <div className="hidden md:grid grid-cols-3 gap-6 lg:gap-8 justify-items-center">
            {categories.map((category, index) => (
              <motion.div
                ...
                className={`group ${category.link ? 'cursor-pointer' : ''} ${category.row === 2 && category.col === 3 ? 'hidden' : ''}`}
